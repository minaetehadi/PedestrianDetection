...
# Train the model (this is simplified for brevity, use more epochs in practice)
...
# Define a function to detect adversarial inputs
def detect_adversarial(x, classifier):
    ...
    # Compare predictions from original and squeezed inputs
    ...
    is_adversarial = (difference_bit > detection_threshold) | (difference_smooth > detection_threshold)
